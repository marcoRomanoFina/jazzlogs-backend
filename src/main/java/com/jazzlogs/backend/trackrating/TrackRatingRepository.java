...
public interface TrackRatingRepository extends JpaRepository<TrackRating, UUID> {
    ...
    // One query for the current user's rating on a whole list of tracks at
    // once — e.g. PlaylistService.getPlaylistDetail needs this batched, not
    // one findByUserIdAndTrackId per track.
